...
document.querySelector("h1").innerHTML = "ZHANNA";
...
document.querySelector(".three").innerHTML = "<h3>ЗАГОЛОВОК h3 c произвольным текстом</h3>";

// Task 11
// Создайте пустой div c классом four. С помощью querySelector запишите внутрь div заголовок h4 
// с произвольным текстом и параграф p с произвольным текстом.Подсказка, чтобы дописывать внутрь
// элемента используейте не innerHTML = , а innerHTML += (плюс равно без пробела).

document.querySelector(".four").innerHTML += "<h4>ЗАГОЛОВОК h4 c произвольным текстом</h4> <p>Параграф с произвольным текстом</p>";
...
let z1 = 6;
let z2 = 3;
let z3 = document.querySelector(".multiply");
z3.innerHTML = z1 * z2;
...
let y1 = 6;
let y2 = 3;
let y3 = document.querySelector(".divide");
...
let x1 = "Hello";
let x2 = 5;
let x3 = document.querySelector(".adding");
x3.innerHTML = x1 + x2;
