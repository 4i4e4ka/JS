...
// Функция должна прочитать содержимое i - 31 и i - 32 в переменные и сравнить их,
//     вывести в out - 3 большее число.

// Проведите самостоятельный тест работы, введите пары чисел 4 и 9, 9 и 22, 5 и 111.

// const button = document.querySelector(".b-3");
// let inputOne = document.querySelector(".i-31");
// let inputTwo = document.querySelector(".i-32");
...
// Функция должна вывести в.out - 4 число 1 если пользователю больше или равно 18 лет,
// и 0 если меньше.
...
// которая запускает функцию f5.Функция должна вывести в.out - 5 символ m
...
// Task 6
// Создайте на странице input[type = number] с классом i - 6, куда пользователь может
...
// остаток от деления на 2(оператор %).
// Если остаток равен нулю - четное, нет - нечетное.

// const button = document.querySelector(".b-6");
...
// const button = document.querySelector(".b-7");
// let inputOne = document.querySelector(".i-71");
// let inputTwo = document.querySelector(".i-72");
...
//    Привести полученную строку к числу  console.log(Number (result))
 

// Task 13
// Дан input i - 130. В отличие от предыдущего задания - input type number.
// По нажатию кнопки получите значение из input в переменную, а затем выведите в out - 13
// typeof полученной переменной.Typeof позволяет определить тип данных.
// Если вы правильно все сделали - то удивительно, но тип данных будет string!
// Подумайте почему так ?

// Task 14
// Дан input i - 141 и input - 142, type = number.
// Дан select s - 143, который содержит две операции - +, -, *, / . 
// Дана кнопка b - 14, при нажатии на которую срабатывает функция f14.
// Функция выводит в out - 14 результат операций выбранной в 3 - м select к числам
// введенным в первом и втором input.Например выбрано 1 13 +,
// нужно вывести результат операции 1 + 13 т.е. 14.



// const button = document.querySelector(".b-14");
// const inpOne = document.querySelector(".i-141");
// const inpTwo = document.querySelector(".i-142");
// const select = document.querySelector(".s-143");
...
// к числам выбранным в первом и втором select.Например выбрано 1 1 &&,
// нужно вывести результат операции 1 && 1 т.е. 1 или 0.

    
const button = document.querySelector(".b-15");
const selectOne = document.querySelector(".s-151");
const selectTwo = document.querySelector(".s-152");
const selectThree = document.querySelector(".s-153");

button.onclick = () => {
    let a = selectOne.value;
    let b = selectTwo.value;
    let c = selectThree.value;
